...
// Se actualiza de forma automatica cada vez que refrescamos la vista o navegador
$().ready(() => {
...
var getEstudiante = () => {
    ...
    if (1 < count) {
        document.getElementById("mensajeEstudianteModal").innerHTML = "Seleccione un estudiante";
    } else {
